myApp.onPageInit('problema_estrada_final', function(page){
$('.back').on('click', function(event){
    ...
    var successCallback = function (data) {
        ...
        $('#contrato6').text(oferta.doc_transporte)
        $('#data_descarga6').text(data_fim)
        $('#cliente_origem6').text(oferta.cliente_origem.nome)
        $('#cliente_destino6').text(oferta.cliente_destino.nome)
        $('#endereco_destino6').text(oferta.cliente_destino.endereco_entrega)
        $('#cidade_destino6').text(oferta.cliente_destino.cidade.nome)
        $('#telefone_destino6').text(oferta.telefone_atendimento_destino)
        $('#data-estrada6').text(data_descarga)
        $('#atraso-estrada6').text(oferta.entrega.ocorrencias[0].tempo_atraso)
        ...
        var successCallback = function (data) {
            ...
            $('#cidade_estado3').text(cidade_estado)
            $('#endereco3').text(endereco)
        }
