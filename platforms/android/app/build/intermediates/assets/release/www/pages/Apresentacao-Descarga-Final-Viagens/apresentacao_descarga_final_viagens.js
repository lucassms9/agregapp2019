myApp.onPageInit('apresentacao_descarga_final_viagens', function (page) {
    myApp.hidePreloader();
    ...
    var successCallback = function (data) {
        ...
        var body = '<div class="card cardinfo segundoCard">' +
            ...
            '</div>' +
            '<div class="text-info">' +
            '<p><span><b>Apresentação de Descarga</b> </span><br> Informada em ' + data_descarga + ' às ' + hora_descarga + '</p>' +
