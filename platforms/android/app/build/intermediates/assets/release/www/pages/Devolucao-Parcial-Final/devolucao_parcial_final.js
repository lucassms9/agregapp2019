myApp.onPageInit('devolucao_parcial_final', function (page) {
    ...
    var successCallback = function (data) {
        ...
        $('#contrato-dev-parcial-final').append(oferta.doc_transporte)
        $('#descarga-dev-parcial-final').append(data_fim)
        $('#destino-dev-parcial-final').append(oferta.cliente_destino.nome)
        $('#endereco-dev-parcial-final').append(oferta.cliente_destino.endereco_entrega)
        $('#cidade-dev-parcial-final').append(oferta.cliente_destino.cidade.nome)
        $('#fone-dev-parcial-final').append(oferta.telefone_atendimento_destino)
        ...
        var successCallback = function (data) {
            ...
            $('#cidade_estado9-dev-parcial').text(cidade_estado);
            $('#endereco9-dev-parcial').text(endereco);
        }
